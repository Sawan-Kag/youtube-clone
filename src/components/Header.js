...
import ytMobile from "../assets/yt-logo-mobile.png";
...
const Header = () => {
  ...
  const { loading, mobileMenu, setMobileMenu, theme, setTheme } = useContext(DataContext);
    ...
    <div className="flex flex-row h-14 px-4 md:px-5 justify-between items-center sticky top-0 z-20 bg-white dark:bg-black shadow-md">
      ...
      <div className="flex h-5 items-center">
        ...
        <Link to="/" className="flex h-5 items-center">
          <img src={youTube} alt="PlayTube" className="h-full hidden md:block" />
          <img src={ytMobile} alt="PlayTube" className="h-8 w-8 md:hidden rounded-full" />
        </Link>
      </div>
      ...
      <div className="flex items-center">
        ...
        <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
          <Link to={"https://github.com/sawan-kag"}>
            <img
